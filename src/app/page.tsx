...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {topRatedVideos.length > 0 && <section id="top-videos" className="py-8 md:py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
      ...
      {topRatedAlbums.length > 0 && <section id="top-albums" className="py-8 md:py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
           <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              Album Designs
