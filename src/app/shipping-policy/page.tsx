                ...
                <div className="prose prose-lg max-w-none prose-headings:font-headline prose-headings:text-foreground prose-a:text-primary hover:prose-a:text-primary/80 dark:prose-invert">
                    ...
                    <div className="mb-8">
                      ...
                      <ul>
                          ...
                          <li><MessageSquare className="inline-block mr-2 h-5 w-5 text-accent" /> <strong>WhatsApp:</strong> For your convenience, we can also deliver the final files or download links directly to your WhatsApp number.</li>
                          <li><FolderDown className="inline-block mr-2 h-5 w-5 text-accent" /> <strong>Google Drive/Cloud Storage:</strong> For larger files, such as full-length edited videos, we will provide a secure link to a cloud storage service like Google Drive from which you can download your files.</li>
                      </ul>
                    </div>
