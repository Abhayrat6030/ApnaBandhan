      ...
      <div className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
        <div className="mx-auto max-w-none rounded-lg bg-card p-8 shadow-lg md:p-12">
            ...
            <div className="prose prose-lg max-w-none prose-headings:font-headline prose-headings:text-foreground prose-a:text-primary hover:prose-a:text-primary/80 dark:prose-invert">
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><Info className="inline-block mr-3 h-6 w-6 text-primary" />Information We Collect</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><User className="inline-block mr-3 h-6 w-6 text-primary" />How We Use Your Data</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><Database className="inline-block mr-3 h-6 w-6 text-primary" />Data Storage and Security</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><Truck className="inline-block mr-3 h-6 w-6 text-primary" />Data Retention</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><Share2 className="inline-block mr-3 h-6 w-6 text-primary" />Data Disclosure and Sharing</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><User className="inline-block mr-3 h-6 w-6 text-primary" />Your Rights</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><AlertTriangle className="inline-block mr-3 h-6 w-6 text-primary" />Children's Privacy</h2>
                ...
                <div className="mb-8">
                  <h2 className="flex items-center"><PenSquare className="inline-block mr-3 h-6 w-6 text-primary" />Changes To This Privacy Policy</h2>
