                ...
                <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <ul className="!my-4">
                          ...
                          <li className="flex items-center"><Info className="inline-block mr-2 h-5 w-5 shrink-0 text-accent" /> <span>By visiting our <Link href="/contact">Contact Page</Link></span></li>
                      </ul>
                    </div>
                </div>
            </div>
