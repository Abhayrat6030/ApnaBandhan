            ...
            <div className="prose prose-lg max-w-none prose-headings:font-headline prose-headings:font-bold prose-headings:text-foreground prose-a:text-primary hover:prose-a:text-primary/80 dark:prose-invert">
                <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-4 prose-h3:!mt-6 prose-h4:!my-2">
                        ...
                        <div>
                          ...
                          <ul className="!my-4">
                              <li className="flex items-start"><Fingerprint className="inline-block mr-2 h-5 w-5 mt-1 shrink-0 text-accent" /> <span><strong>Contact Information:</strong> Full Name, Email Address, Phone Number.</span></li>
                              <li className="flex items-start"><PenSquare className="inline-block mr-2 h-5 w-5 mt-1 shrink-0 text-accent" /> <span><strong>Event Details:</strong> Names of the couple/individuals, parents' names, event dates, times, and venue addresses.</span></li>
                              <li className="flex items-start"><Share2 className="inline-block mr-2 h-5 w-5 mt-1 shrink-0 text-accent" /> <span><strong>Project Content:</strong> Photographs, videos, text, and any other materials you provide for the creation of your invitations, videos, or albums.</span></li>
                              <li className="flex items-start"><MessageSquare className="inline-block mr-2 h-5 w-5 mt-1 shrink-0 text-accent" /> <span><strong>Communication Data:</strong> Records of your correspondence with us via email, WhatsApp, or phone.</span></li>
                          </ul>
                        </div>
                    ...
                    <div>
                      ...
                      <ul className="!my-4">
                          ...
                          <li className="flex items-start"><Info className="inline-block mr-2 h-5 w-5 mt-1 shrink-0 text-accent" /> <span>By visiting our <Link href="/contact">Contact Page</Link></span></li>
                      </ul>
                    </div>
                </div>
            </div>
